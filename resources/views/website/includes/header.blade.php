...
<a href="{{route('dashboard')}}">Hello</a>
</div>
<ul class="user-login">
<li>
...
<a href="javascript:void(0)" class="remove" title="Remove this item"><i class="lni lni-close"></i></a>
<div class="cart-img-head">
<a class="cart-img" href="product-details.html"><img src="{{asset('/')}}website/{{asset('/')}}website/assets/images/header/cart-items/item2.jpg" alt="#"></a>
</div>
<div class="content">
...
<li><a href="{{route('category.page')}}">accessories</a></li>
...
<li class="nav-item">
<a href="{{route('home.page')}}" class="active" aria-label="Toggle navigation">Home</a>
</li>
<li class="nav-item">
...
<li class="nav-item"><a href="{{route('category.page')}}">Shop Grid</a></li>
<li class="nav-item"><a href="product-list.html">Shop List</a></li>
<li class="nav-item"><a href="{{route('category.detail')}}">shop Single</a></li>
<li class="nav-item"><a href="{{route('cart.page')}}">Cart</a></li>
<li class="nav-item"><a href="{{route('checkout.page')}}">Checkout</a></li>
</ul>
</li>
<li class="nav-item">
